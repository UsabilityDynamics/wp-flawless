 ...
 */ 
  ...
  if(is_home() && $fs['hide_meta_data_on_home_page'] == 'true') {
    return;
  }

  if(is_category() && $fs['hide_meta_data_on_category_pages'] == 'true') {
    return;
  }
...
<ul class="entry-meta header">
  ...
  <?php if(post_type_supports($post->post_type, 'author')): ?>
  ...
  <?php if($fs['post_types'][$post->post_type]['show_post_meta'] == "true"): ?>
