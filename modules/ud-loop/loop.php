<?php
/**
 * Usability Dynamics Version of the Carrington Build Loop Module
 ...
 *
 * Don't forget to call ud_module_loop::init() in your constructor if you
 * derive from this class!
 */
if (!class_exists('ud_module_loop') && class_exists('cfct_build_module')) {
	class ud_module_loop extends cfct_build_module {
...
// Content Move Helpers
	...
	//cfct_build_register_module('ud_module_loop');
}
?>